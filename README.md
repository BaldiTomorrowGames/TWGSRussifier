...
Этот мод добавляет русский перевод для игры Baldi's Classic Remastered. Проект наиходится в актвной разработке и **код может быть сырым**. На данный момент реализовано 100% задуманного кода.
