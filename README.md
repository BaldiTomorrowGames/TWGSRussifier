...
Этот мод добавляет русский перевод для игры Baldi's Basics Classic Remastered. Проект находится в активной разработке и **код может быть сырым**. На данный момент реализовано 100% задуманного кода.
