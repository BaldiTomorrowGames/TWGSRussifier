# TomorrowGames Baldi's Basics Classic Remastered Russifier

![Версия](https://img.shields.io/badge/Версия-1.0.0-blue)
![Статус разработки](https://img.shields.io/badge/Статус-100%25-yellow)
![Игра](https://img.shields.io/badge/Игра-Baldi's%20Basics%20Classic%20Remastered%201.1-green)

## 📝 Описание

Этот мод добавляет русский перевод для игры Baldi's Basics Classic Remastered. Проект наиходится в актвной разработке и **код может быть сырым**. На данный момент реализовано 100% задуманного кода.
...
2. Установите [CyrillicPlus](https://gamebanana.com/mods/524258)
...
- [Baldi's Basics Classic Remastered](https://www.basicallygames.com/baldis-basics-classic) <sub><sup>(1.1)</sub></sup>
